"""Autograder Notebook 03: Q Learning
Ejercicios: 1. implement_q_learning (25), 2. epsilon_greedy (20), 3. q_learning_episode (25), 4. plot_q_values (15), 5. compare_alphas (15)
...
class Grader:
    def __init__(self):
        ...
        self.exercise_points = {'implement_q_learning': 25, 'epsilon_greedy': 20, 'q_learning_episode': 25, 'plot_q_values': 15, 'compare_alphas': 15}
    ...
    def print_report(self):
        print("\n" + "="*70)
        print(f"📊 NOTEBOOK 03: Q LEARNING")
        print("="*70 + "\n")
...
def test_final_report():
    ...
    for ex_name, pts in grader.exercise_points.items():
        try:
            from notebook_03_exercises import {ex_name}
