"""Autograder Notebook 06: Actor Critic
Ejercicios: 1. actor_network (20), 2. critic_network (20), 3. compute_advantage (25), 4. actor_critic_update (20), 5. train_a2c (15)
...
class Grader:
    def __init__(self):
        ...
        self.exercise_points = {'actor_network': 20, 'critic_network': 20, 'compute_advantage': 25, 'actor_critic_update': 20, 'train_a2c': 15}
    ...
    def print_report(self):
        print("\n" + "="*70)
        print(f"📊 NOTEBOOK 06: ACTOR CRITIC")
        print("="*70 + "\n")
...
def test_final_report():
    ...
    for ex_name, pts in grader.exercise_points.items():
        try:
            from notebook_06_exercises import {ex_name}
