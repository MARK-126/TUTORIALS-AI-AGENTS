"""Autograder Notebook 04: Deep Q Networks
Ejercicios: 1. build_dqn_network (20), 2. experience_replay (25), 3. target_network_update (20), 4. train_dqn_step (20), 5. evaluate_dqn (15)
...
class Grader:
    def __init__(self):
        ...
        self.exercise_points = {'build_dqn_network': 20, 'experience_replay': 25, 'target_network_update': 20, 'train_dqn_step': 20, 'evaluate_dqn': 15}
    ...
    def print_report(self):
        print("\n" + "="*70)
        print(f"📊 NOTEBOOK 04: DEEP Q NETWORKS")
        print("="*70 + "\n")
...
def test_final_report():
    ...
    for ex_name, pts in grader.exercise_points.items():
        try:
            from notebook_04_exercises import {ex_name}
